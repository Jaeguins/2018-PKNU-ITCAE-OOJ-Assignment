...
const CComplex CComplex::operator+(const CComplex& b) {return CComplex(realNum + b.realNum, virtualNum + b.virtualNum);}
const CComplex CComplex::operator-(const CComplex& b) {return CComplex(realNum - b.realNum, virtualNum - b.virtualNum);}
const CComplex CComplex::operator-(double b) {return CComplex(realNum - b, virtualNum);}
const CComplex CComplex::operator+(double b) {return CComplex(realNum + b, virtualNum);}
CComplex operator+(double b, CComplex& a) {return a + b;}
CComplex operator-(double b, CComplex& a) {return a - b;}
